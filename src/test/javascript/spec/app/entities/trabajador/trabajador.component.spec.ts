...
import { TrabajadorComponent } from 'app/entities/trabajador/trabajador.component';
  ...
  describe('Trabajador Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TrabajadorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.trabajadors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
