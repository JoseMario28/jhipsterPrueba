...
describe('Service Tests', () => {
  describe('Trabajador Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(TrabajadorService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Trabajador(0, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Trabajador', async () => {
        const returnedFromService = Object.assign(
          {
            dni: 1,
            nombre: 'BBBBBB',
