...
import { CompraVentaComponent } from 'app/entities/compra-venta/compra-venta.component';
...
describe('Component Tests', () => {
  describe('CompraVenta Management Component', () => {
    let comp: CompraVentaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CompraVentaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.compraVentas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
