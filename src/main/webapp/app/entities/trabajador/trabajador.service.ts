...
export class TrabajadorService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/trabajadors';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ITrabajador[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
