...
import { ClienteInfoDialogComponent, ClienteInfoPopupComponent } from './cliente-info-dialog/cliente-info-dialog.component';
...
export const clienteRoute: Routes = [
  {
    ...
    data: {
      ...
      defaultSort: 'id,asc',
      pageTitle: 'pruebaApp.cliente.home.title'
    },
...
export const clientePopupRoute: Routes = [
  ...
  },
  {
    ...
    data: {
      authorities: ['ROLE_USER'],
      pageTitle: 'pruebaApp.cliente.home.info'
    },
    canActivate: [UserRouteAccessService],
    outlet: 'popup'
  }
